        ...
        <div class="booking-card mb-5" style="opacity: 90%;">
            <div class="booking-card-body">
                <form action="/book-vehicle" method="POST">
                    ...
                    <div class="form-group">
                        <label>From</label>
                        <input type="text" name="from" class="form-control @error('from') is-invalid @enderror" value="{{ old('from') }}" placeholder="e.g. Jorhat" required>
                        @error('from')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="destination" class="form-control @error('destination') is-invalid @enderror" value="{{ old('destination') }}" placeholder="e.g. Guwahati" required>
                        @error('destination')
                            <span class="invalid-form-field" role="alert">{{ $message }}</span>
                        @enderror
                    </div><br><hr><br>
